public class B3_HalfTheRed extends World {
    ...
    public void go() {
        ...
        for (int row = 1; row < 217; row = row + 1) {
            for (int col = 1; col < 202; col++) {
...
//                plane.teleport(col, 488 - row);
                if (red == 137 && green == 191 && blue == 54) {
                    System.out.println("green not zero");
                    plane.setPixelColor(200, 0, 200);
                   ...
                   System.out.println("rgb does not equal 75");
                }
            }
        }
    }
